      ...
      <div class="mt-md-0 col-lg-8 col-md-8 mt-8 mt-md-0" data-aos="zoom-in">
            <div class="box featured">
              <div class="form-w3-agile">
			        <h2>bienvenue a la famille francoPHONE</h2>
			        <form action="registration.php" method="post">
                
                  <div class="col-md-12 form-group">
                  <input placeholder="Nom et Prenom" name="clientName" class="form-control" type="text" required>
                  ...
                  <p><br></p>
                  <div class=" col-md-12 form-group">
                  <input placeholder="Numero d'identité" name="idNum" class="form-control" type="text" required >
													<div class="icon-agile">
														<i class="fa fa-user" aria-hidden="true"></i>
													</div>
                  </div>
                  <p><br></p>
                  <div class=" col-md-12 form-group">
                  <input placeholder="Numero de telephone joignable" name="phoneNum" class="form-control" type="text" required>
													<div class="icon-agile">
                  ...
                  <p><br></p>
                  <div class=" col-md-12 form-group">
                  <input placeholder="Email" name="emailAdress" class="form-control"  type="email"required >
													<div class="icon-agile">
                  ...
                  <p><br></p>
                  <div class=" col-md-12 form-group">
                  <input placeholder="Adresse pour livraison" name="Adresse"  class="form-control" type="text"required >
                  ...
                  <p><br></p>
				          ...
				          <!-- <div class="mySpecial"> -->
                   <!-- <a type="submit" name="submit" class="btn-buy">inscription</a> -->
                   <input type="submit" name="submit" class="mySpecial" value="inscription">
                 <!-- </div> -->
