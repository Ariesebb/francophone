...
$sql = "SELECT * from purchase WHERE STATUS = 'accomplie' ;  ";
$sql2 = "SELECT * from purchase WHERE STATUS = 'accomplie' AND MONTH(DATE) = MONTH(curdate()) ;  ";
$result = mysqli_query($con, $sql);
$result2 = mysqli_query($con, $sql2);
// $row = mysqli_fetch_assoc($result);
$sumToDo = mysqli_num_rows($result);
$sumThisMounth = mysqli_num_rows($result2);
?>
...
<section id="breadcrumbs" class="breadcrumbs">
  <div class="container">
    ...
    <ol>
      ...
      <li><a href="CRM-francoPHONE.php">en attente</a></li>
      <li><a href="CRM-activation.php">en activation</a></li>
      <li>accomplie</li>
    </ol>
    <?php 
    echo '<h2>accomplie ce mois ci: ',$sumThisMounth,'</h2>' ;
    ?>
...
if($sumToDo > 0){
 ...
 <div class="container mt-5">
    <h3 class="text-center mb-3">Accomplie</h3>
